package fr.maxlego08.zkoth.inventory;
...
import fr.maxlego08.zkoth.exceptions.InventoryOpenException;
import fr.maxlego08.zkoth.zcore.utils.ZUtils;
import fr.maxlego08.zkoth.zcore.utils.builder.ItemBuilder;
import fr.maxlego08.zkoth.zcore.utils.inventory.InventoryResult;
import fr.maxlego08.zkoth.zcore.utils.inventory.ItemButton;

public abstract class VInventory extends ZUtils implements Cloneable {

	protected int id;
	protected ZKothPlugin plugin;
	...
	protected InventoryResult preOpenInventory(ZKothPlugin main, Player player, int page, Object... args)
	...
	public abstract InventoryResult openInventory(ZKothPlugin main, Player player, int page, Object... args)
			throws InventoryOpenException;
	 ...
	 * @param player
	 */
	protected void onClose(InventoryCloseEvent event, ZKothPlugin plugin, Player player) {
	}
	 ...
	 * @param player
	 */
	protected void onDrag(InventoryDragEvent event, ZKothPlugin plugin, Player player) {
	}
